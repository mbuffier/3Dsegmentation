...
ITMLibSettings::ITMLibSettings(void)
	: sceneParams(0.02f, 100, 0.005f, 0.2f, 6.0f, false) // size band, average, voxel size, min and max integration 
{
	// before : 0.005 for the voxel size and 0.02 for mu -> still 4 voxel in the TSF  
	...
	useBilateralFilter = true ; //****** CHANGED *******

	segmentation = true ; //****** CHANGED *******
