...
//modification for the label propagation 
template<class TVoxel, class TIndex>
...
{
	// allocation -> sceneReconstructionEngine
	sceneRecoEngine->AllocateSceneFromDepth(scene, view, trackingState, renderState);

	// integration //*** HERE THE MODIFICATION ***
	sceneRecoEngine->IntegrateIntoScene(scene, view, trackingState, renderState, mergingRecord);
