	...
	namespace Objects
	{
		...
		public:
			...
			*/
			...
			// will create the label result into the model 
			ORUtils::Image<int> *labelResult ;

			// will create the label result into the model 
			ORUtils::Image<int> *confidence ;
			...
			ITMRenderState(const Vector2i &imgSize, float vf_min, float vf_max, MemoryDeviceType memoryType)
			{
				...
				labelResult = new ORUtils::Image<int>(imgSize, memoryType);
				confidence = new ORUtils::Image<int>(imgSize, memoryType);				
