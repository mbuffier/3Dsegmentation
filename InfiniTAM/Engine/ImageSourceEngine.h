...
namespace InfiniTAM
{
	namespace Engine
	{
		...
		public:
			...
			virtual void getAllImages(ITMUChar4Image *rgb, ITMShortImage *rawDepth, ITMShortImage *sem) = 0 ;
		...
		private:
			...
			char semImageMask[BUF_SIZE]; // the segmentation 

			ITMUChar4Image *cached_rgb;
			ITMShortImage *cached_depth;
			ITMShortImage *cached_sem; // the segmentation 
		...
		public:
			...
			ImageFileReader(const char *calibFilename, const char *rgbImageMask, const char *depthImageMask, const char *semImageMask);

			~ImageFileReader();

			bool hasMoreImages(void);
			void getImages(ITMUChar4Image *rgb, ITMShortImage *rawDepth);
			void getAllImages(ITMUChar4Image *rgb, ITMShortImage *rawDepth, ITMShortImage *sem);
