...
namespace ITMLib
{
	namespace Engine
	{
		...
		public:
			...
			static void BinaryToUchar4(ITMUChar4Image *dst, ITMBoolImage *src);
			static void IntToUchar4(ITMUChar4Image *dst, ITMIntImage *src);
			static void ShortToUchar4(ITMUChar4Image *dst, ITMShortImage *src) ;
			...
			*/
			...
			// to create the image with color information 
			virtual void CreateICPMapsWithColor(const ITMView *view, ITMTrackingState *trackingState, 
			ITMRenderState *renderState) const = 0;
